...
void sensors_control (void *param){
  ...
  Wire.begin(32,33,400000UL);     //Inicializamos la comunicación i2C para la IMU MPU6050
...
void setup() {
  ...
  xTaskCreatePinnedToCore(sensors_control,"Task1",4096,NULL,1,&Task1,0); //Control y lectura de sensores, en el núcleo 0
  xTaskCreatePinnedToCore(MIDI_control,"Task2",4096,NULL,1,&Task2,1);    //Comunicación MIDI, en el núcleo 1
}
